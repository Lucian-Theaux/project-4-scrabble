...
def carre():            # ROMEO NE MET PAS D'ACCENT EN PROGRAMMATION
   for i in range(4):
        down()
        forward(50)
        left(90)

def Bareme():           # ROMEO NE MET PAS D'ACCENT EN PROGRAMMATION
    up()
    goto(-800,350)
...
def ecriture(mot):     # ROMEO NE MET PAS D'ACCENT EN PROGRAMMATION
    write(mot)
