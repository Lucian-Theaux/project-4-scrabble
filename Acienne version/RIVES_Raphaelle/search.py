...
def recherche(mot :str) -> tuple:
    """
    recherche: Cherche le mot dans le fichier texte mots_autorises.txt 
    en paramètre: mot: chaine de charactères prise en entrée
    renvoie:- un tuple contenant une vérification de la présence du mot (True/False) 
            - son index dans le fichier (si False, renvoie 0)
    """
